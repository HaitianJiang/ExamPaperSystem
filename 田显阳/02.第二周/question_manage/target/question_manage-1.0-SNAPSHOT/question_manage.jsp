			...
			<form action="QuestionChange" method="post">
				<div class="question" name="ss">
					...
					<div class="question_head clearfix">
						<div class="item_name">题号:</div> <input class="item_input" type="text" placeholder="" name="pro_no" size="60"
																readonly="readonly" value="1" /><br />
						<div  class="item_name">类型：</div> <input class="item_input" type="text" placeholder="选择题 " name="pro_type"
					...
					<div class="question_body">
						...
						<div class="item_name">题目:</div> <input class="item_input" type="text" placeholder="常见的线程种类有() " name="pro_detail"
						 size="60" readonly="readonly" /><br />
						<div class="item_name">A:</div> <input class="item_input" type="text" placeholder="选用户线程" size="60" name="option_A"
						 readonly="readonly" /><br />
						<div class="item_name">B:</div> <input class="item_input" type="text" placeholder="内核线程" size="60" name="option_B"
						 readonly="readonly" /><br />
						<div class="item_name">C:</div> <input class="item_input" type="text" placeholder="轻量级进程" size="60" name="option_C"
						 readonly="readonly" /><br />
						<div class="item_name">D:</div> <input class="item_input" type="text" placeholder="线程" size="60" name="option_D"
						 readonly="readonly" /><br />
					</div>
					<!-- 问题的 属性 难度 -->
					<div class="question_answer">
						<div class="item_name">答案:</div> <input class="item_input" type="text" placeholder="ABC" size="60" name="pro_ansno"
						 readonly="readonly" /><br />
					</div>
				</div>
				<!-- <button >提交</button> -->
			...
			<form action="index.html" method="get">
				<div class="question" name="ss">
					...
					<div class="question_head clearfix">
						<div class="item_name">题号:</div> <input class="item_input" type="text" placeholder="" name="pro_no" size="60"
						 readonly="readonly" value="1" /><br />
						<div id="question_id" class="item_name">类型：</div> <input class="item_input" type="text" placeholder="选择题 " name="pro_type"
						 size="60" readonly="readonly" /><br />
						<div class="question_change">
							<a href="#"><img name="revise_img" class="ico" width="20px" src="./img/修改.png" title="修改"></a>
							<a href="#"><img name="delect_img" class="ico" width="20px" src="./img/删 除.png" title="删除"></a>
