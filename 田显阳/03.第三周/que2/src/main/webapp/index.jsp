	...
	<div class="form_style" id="login_form">
		...
		<div>
			<form method="post" action="${pageContext.request.contextPath}/LoginServlet">
				<div id="login_input_id"><input type="text" name="username" placeholder="请输入学号/工号/账号"></div>
				<div id="login_input_pd"><input type="password" name="password" placeholder="请输入密码"></div>
				<div id="login_modify_pd"><a href="${pageContext.request.contextPath}/jsp/passwdcg.html">修改密码</a></div>
