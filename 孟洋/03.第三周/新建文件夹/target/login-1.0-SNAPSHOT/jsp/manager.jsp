...
<div class="mid">
                ...
                <li>
                    <div class="opt" id="add" onclick="clickadd()">
                        <div class="ico" id="add_ico">
                            <img onclick="clickadd()" src="${pageContext.request.contextPath}/img/add.svg" width="70%"
                                 height="70%"/>
    ...
    <div class="middle">
        <div class="data">
            ...
            <iframe id="subframe" src="${pageContext.request.contextPath}/jsp/list_course.jsp" frameborder="0"
                    width="996px" height="562px" noresize="noresize" scrolling="auto"></iframe>
        </div>

    </div>
    <div class="right">
        <div class="right_title">
            <a href="${pageContext.request.contextPath}/teacherListServlet">口令校验队列</a>
        </div>
...
<script>
    ...
    function clickuser() {
        nowfocus = 1;
        document.getElementById("subframe").src = "${pageContext.request.contextPath}/jsp/list_course.jsp";
    }
