...
<html>
	...
	<body>
		<div class="top-bar">
			<div class="text-title"><a href="${pageContext.request.contextPath}/index.html">试卷管理系统</a></div>
		</div>
		<div class="mid">
			<div class="left">
				<div class="list">
			...
			<div class="middle">	
				<div class="data">
					...
					<iframe  id="subframe" src="list_course.html" frameborder="0" width="996px" height="562px" noresize="noresize" scrolling="auto"></iframe>
				</div>
...
<script>
	...
	{
		nowfocus = 1;
		document.getElementById("subframe").src = "list_course.html";
	}
	function clickadd()
	{
		nowfocus = 2;
